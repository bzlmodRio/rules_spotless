...
public class FormatExtension {
	...
	public ArrayList<FormatterStep> getSteps() {
	...
	public void addStep(FormatterStep newStep) {
		...
		if (existingIdx != -1) {
			throw new RuntimeException(); //GradleException("Multiple steps with name '" + newStep.getName() + "' for spotless format '" + formatName() + "'");
		}
		steps.add(newStep);
	}
	...
	protected void replaceStep(FormatterStep replacementStep) {
		...
		if (existingIdx == -1) {
			throw new RuntimeException("Cannot replace step '" + replacementStep.getName() + "' for spotless format '" + formatName() + "' because it hasn't been added yet.");
		}
	...
	class BazelProvisioner implements Provisioner
	{
		public Set<File> provisionWithTransitives(boolean withTransitives, Collection<String> mavenCoordinates) {
			// System.out.println("Provisioner getting called" + withTransitives + ", " + mavenCoordinates);
			String base = "/home/pjreiniger/git/allwpilib/bazel-allwpilib/external/rules_spotless_dependencies/";

			// /home/pjreiniger/git/allwpilib/bazel-allwpilib/external/rules_spotless_dependencies

			Set<File> output = new HashSet<>();
			output.add(new File(base + "v1/https/repo1.maven.org/maven2/com/google/googlejavaformat/google-java-format/1.15.0/google-java-format-1.15.0.jar"));
			output.add(new File(base + "v1/https/repo1.maven.org/maven2/com/google/guava/guava/31.0.1-jre/guava-31.0.1-jre.jar"));
			// output.add(new File("/home/pjreiniger/git/bzlmodRio/bzlmodRio-allwpilib/tests/bazel-tests/external/rules_spotless_dependencies/v1/https/repo1.maven.org/maven2/com/google/code/findbugs/jsr305/3.0.2/jsr305-3.0.2.jar"));
			
			
			// output.add(new File("/home/pjreiniger/git/bzlmodRio/bzlmodRio-allwpilib/tests/bazel-tests/external/rules_spotless_dependencies/v1/https/repo1.maven.org/maven2/com/google/code/findbugs/jsr305/3.0.2/jsr305-3.0.2.jar"));
			// output.add(new File("/home/pjreiniger/git/bzlmodRio/bzlmodRio-allwpilib/tests/bazel-tests/external/rules_spotless_dependencies/v1/https/repo1.maven.org/maven2/com/google/errorprone/error_prone_annotations/2.7.1/error_prone_annotations-2.7.1.jar"));
			// output.add(new File("/home/pjreiniger/git/bzlmodRio/bzlmodRio-allwpilib/tests/bazel-tests/external/rules_spotless_dependencies/v1/https/repo1.maven.org/maven2/com/google/guava/failureaccess/1.0.1/failureaccess-1.0.1.jar"));
			// output.add(new File("/home/pjreiniger/git/bzlmodRio/bzlmodRio-allwpilib/tests/bazel-tests/external/rules_spotless_dependencies/v1/https/repo1.maven.org/maven2/com/google/guava/guava/31.0.1-jre/guava-31.0.1-jre.jar"));
			// output.add(new File("/home/pjreiniger/git/bzlmodRio/bzlmodRio-allwpilib/tests/bazel-tests/external/rules_spotless_dependencies/v1/https/repo1.maven.org/maven2/com/google/guava/listenablefuture/9999.0-empty-to-avoid-conflict-with-guava/listenablefuture-9999.0-empty-to-avoid-conflict-with-guava.jar"));
			// output.add(new File("/home/pjreiniger/git/bzlmodRio/bzlmodRio-allwpilib/tests/bazel-tests/external/rules_spotless_dependencies/v1/https/repo1.maven.org/maven2/com/google/j2objc/j2objc-annotations/1.3/j2objc-annotations-1.3.jar"));
			// output.add(new File("/home/pjreiniger/git/bzlmodRio/bzlmodRio-allwpilib/tests/bazel-tests/external/rules_spotless_dependencies/v1/https/repo1.maven.org/maven2/org/checkerframework/checker-qual/3.12.0/checker-qual-3.12.0.jar"));
	...
	public class PrettierConfig extends NpmStepConfig<PrettierConfig> {
		...
		protected FormatterStep createStep() {
            throw new GradleException("UHOH");
    ...
    private class GradleException extends RuntimeException {
        public GradleException(String str) { super(str); }
    }
}